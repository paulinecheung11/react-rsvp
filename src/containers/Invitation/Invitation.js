          ...
          <div className='main'>
            ...
            <div className='top py-sm-3 py-lg-6 text-center'>
              ...
              <div className='py-sm-3 py-lg-6 col-10 mx-auto'>
                <p className='top__desc mx-auto text-serif'>
                  Five years ago we both set off to travel the world, having no
                  ...
                  the way, and we are so excited to celebrate with you in
                  Boston.
                </p>
            ...
            <div className='bottom py-6'>
              ...
              <ol className='timeline text-plex text-cream mx-auto'>
                ...
                <li className='d-flex flex-items-center py-sm-3 py-lg-6'>
                  <p>
                    At the beginning of 2020 we travelled to New Zealand, and
                    our two month trip turned into a year and a half as the
                    pandemic kept us from returning home. We were{' '}
                    <a
                      className='text-link'
                    ...
                    in a beautiful ceremony, but we never had our chance to
                    celebrate with family and friends.
                  </p>
                </li>
                <li className='d-flex flex-items-center py-sm-3 py-lg-6'>
                  <p>Our Squamish Wedding</p>
                </li>
