        ...
        <div className='mainframe mx-auto'>
          ...
          <div className='main'>
            ...
            <div className='bottom py-6'>
              ...
              <ol className='timeline text-plex text-cream mx-auto'>
                ...
                <li className='d-flex flex-items-center py-sm-3 py-lg-6'>
                  <p>
                    On our pre-wedding trip to New Zealand in{' '}
                    <span className='text-bold'>March 2020</span>, the world was
                    turned on its side. Borders closed as the pandemic worsened,
                    and we couldn’t imagine being forced to separate. To stay
                    together, we tied the knot! In a 5 day whirlwind, we planned
                    and re-planned an impromptu{' '}
                    <a
                      className='text-link'
                      target='_blank'
                      rel='noopener noreferrer'
                      href='https://medium.com/@nexus009/w%C4%81naka-a-love-story-87a6428603db'
                    >
                      wedding in Wanaka
                    </a>
                    . The community surrounded us with love and hope to make the
                    day special.
                  </p>
                </li>
                <li className='d-flex flex-items-center py-sm-3 py-lg-6'>
                  <p>
                    Our big day is postponed, but we can’t wait to celebrate
